            ...
            @include('includes.mensaje')
                <div class="card pub_image pub_image_detail">
                    <div class="card-header">
                        ...
                        @endif
                        <div class="data-user">
                            {{-- {{ route('profile', ['id' => $image->user->id])}} --}}
                    ...
                    <div class="card-body">
                            ...
                            <div class="likes">
                                {{--Comprobar si el usuario actual le dio like a una publicacion--}}
                            ...
                            @if(Auth::user() && Auth::user()->id == $image->user->id)
                                <div class="actions">
                                    <a href=" {{route('image.edit',['id'=>$image->id])}}" class="btn btn-sm btn-primary">Actualizar publicacion</a>
