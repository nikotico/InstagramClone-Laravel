    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('user.update') }}" enctype="multipart/form-data" aria-label="{{ __('Configuracion') }}">
                        @csrf
                        ...
                        <!--Un reto puede ser cambiar tambien la contraseña-->

                        <!--Aqui un ejemplo de como subir y manejar archivos con laravel
                            Tambien tengo que revisar config\filesystems.php para los espacios de disco-->

                        <div class="form-group row">
                            <label for="image_path" class="col-md-4 col-form-label text-md-right">{{ __('Foto de perfil') }}</label>

                            <div class="col-md-6">
                                @include('includes.avatar')<!--Codigo que uso en varios lugares-->
